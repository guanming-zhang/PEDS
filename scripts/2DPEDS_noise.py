...
N = 2
alpha = 0.1
solver = peds_solver.solver(N,m,0,100,nsteps = 8000,alpha=alpha)
sigma = 0.2
nruns = 500
gmin_x = -6
lmin_x = 4
...
for i in range(nruns):
    ...
    solver.fvec_type = 'c'
    sol = solver.ivp_sde(sigma=sigma,method='EM')
...
import json
with open('peds_poly_sde_noise.txt', 'w') as f:
